...
interface SnackBoxSeriesProps {
  title: String
  size: String
  price: string
}

export const SnackBoxSeries: FunctionComponent<SnackBoxSeriesProps> = ({
  title,
  size,
  price,
}) => {
        ...
        <div>
          ...
          <ul className="my-4 space-y-2">
            ...
            <li className="flex items-center">
              ...
              <p className="font-medium text-black">Bahan Kraft PE 290 Gr</p>
            </li>
            <li className="flex items-center">
              <div className="mr-3">
                <svg
