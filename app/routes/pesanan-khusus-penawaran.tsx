...
import { LunchBoxSeries } from '~/components/pesanan-khusus'
    ...
    <div className="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      ...
      <div className="grid max-w-lg gap-10 row-gap-8 lg:max-w-screen-xl sm:row-gap-10 lg:grid-cols-3 xl:max-w-screen-xl sm:mx-auto">
        ...
        <div className="flex flex-col relative transition duration-300 bg-white rounded shadow-sm hover:shadow border-fujibox">
          <div className="relative w-full h-[12rem] lg:h-[18rem]">
            <img
              src="https://media.graphassets.com/output=format:jpg/resize=height:800,fit:max/09D7dFhStCC1KyVq4ox2"
              className="object-cover w-full h-full rounded-t"
              alt="Plan"
            />
          </div>
          <div className="flex flex-col justify-around flex-grow p-8 border border-t-0 rounded-b">
            <div>
              <div className="text-2xl font-semibold">Snackbox Kraft 12</div>
              ...
              <ul className="my-4 space-y-2">
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-black">Ukuran 12 x 12 x 7cm</p>
                </li>
                <li className="flex items-center">
                  <div className="mr-3">
                    <svg
        ...
        <div className="flex flex-col relative transition duration-300 bg-white rounded shadow-sm hover:shadow border-fujibox">
          ...
          <div className="flex flex-col justify-around flex-grow p-8 border border-t-0 rounded-b">
            <div>
              <div className="text-2xl font-semibold">Snackbox Kraft 14</div>
              ...
              <ul className="my-4 space-y-2">
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-black">Ukuran 12 x 14 x 7cm</p>
                </li>
                <li className="flex items-center">
                  <div className="mr-3">
                    <svg
        ...
        <div className="flex flex-col relative transition duration-300 bg-white rounded shadow-sm hover:shadow border-fujibox">
          ...
          <div className="flex flex-col justify-around flex-grow p-8 border border-t-0 rounded-b">
            <div>
              <div className="text-2xl font-semibold">Snackbox Kraft 16</div>
              ...
              <ul className="my-4 space-y-2">
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-black">Ukuran 12 x 16 x 7cm</p>
                </li>
                <li className="flex items-center">
                  <div className="mr-3">
                    <svg
